"""
Script used to create an icon file for mac (icns) from a PNG.
Make sure that the PNG file is either 512x512 300dpi or 1024x1024 300dpi.

Usage:
    python3 conv_icns.py `icon_file.png`

This script was not created by me, found it here: 
    https://discussions.apple.com/thread/250169140
"""
